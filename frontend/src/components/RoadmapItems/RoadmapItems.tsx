              ...
              <li
                ...
                {task.status === "complete" ? (
                  <>
                    ...
                    <RoadmapItem current={false} name={task.name} description={task.description} complete={true} />
                  </>
                ) : task.status === "current" ? (
                  <>
                    {taskIdx !== step.tasks.length - 1 ? (
                    ...
                    <RoadmapItem current={true} name={task.name} description={task.description} />
                  </>
                ) : (
                  <>
                    {taskIdx !== step.tasks.length - 1 ? (
                    ...
                    <RoadmapItem current={false} name={task.name} description={task.description} />
                  </>
                )}
              </li>
            ))}
